...
const STICKERS_AMOUNT = 57;
const photos = new Array(STICKERS_AMOUNT);
(() => {
  for (let i = 0; i < STICKERS_AMOUNT; i++) {
    photos[i] = `stickers/${i + 1}.png`;
  }
})();
      ...
      <div>
        <div className="main-content">
          <div className="sidebar">
            ...
            <p>
              I've stole it shamelessly from github repo and stack overflow and
              glued it with anger.
            </p>
            <p>
              Click on sticker template, add bottom and top text, save image,
              sent it to me. If you think its that good.
            </p>
          </div>
